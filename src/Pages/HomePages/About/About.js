...
const About = () => {
    return (
        <div>
            <h1 className="#about mt-5 text-center text-warning fw-bold">About Us</h1>
            <div className="container">
                <div className="row">
                  ...
                  <img className="img" src={about} alt="" />
                    ...
                    <p>Our mission is to bring our customers quality products, at the lowest price with the best service in the industry. That is why we are premier online marijuana dispensary! We offer our clients a user-friendly platform where you are only a few clicks away from guaranteed delivery of the highest quality marijuana products right to your front door-step.</p>
                    </div>
                    <div className="col-md-4">
